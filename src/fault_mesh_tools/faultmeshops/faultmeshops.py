...
def create_quad_mesh_from_fault(points: np.ndarray, edges: np.ndarray, triangles: np.ndarray, resolution: float=5000.0,
    ...
    (points_local, edges_local, fault_is_plane) = fault_global_to_local(points, rotation_matrix, plane_origin,
...
def get_fault_rotation_matrix(plane_normal: np.ndarray, cutoff_vecmag: float = 0.98):
    ...
    tan_dir2 = np.cross(plane_normal, tan_dir1)
...
def fault_global_to_local(points: np.ndarray, rotation_matrix: np.ndarray, plane_origin: np.ndarray,
                          edges: np.ndarray = None, plane_epsilon: float = 1.0):
    """
...
def fault_local_to_global(points: np.ndarray, rotation_matrix: np.ndarray, plane_origin: np.ndarray,
